...
public class DriverController {
  ...
  public List<Order> getPendingOrders(@PathVariable("id") String id)
      throws UserNotExistException {
    if (!driverService.getUser(id).isPresent()) {
      throw new UserNotExistException("User doesn't exist");
    }
  ...
  @PostMapping(path = "/accept")
    @io.swagger.v3.oas.annotations.parameters.RequestBody(
      description = "Driver accept order request",
      required = true,
      content = @io.swagger.v3.oas.annotations.media.Content(
        schema = @io.swagger.v3.oas.annotations.media.Schema(implementation = com.cs5500.NEUEat.dto.request.AcceptOrderRequest.class)
      )
    )
    ...
    if (!driverService.getUser(driverId).isPresent()) {
      throw new UserNotExistException("User doesn't exist");
    }
  ...
  @PostMapping(path = "/finish")
    @io.swagger.v3.oas.annotations.parameters.RequestBody(
      description = "Driver finish order request",
      required = true,
      content = @io.swagger.v3.oas.annotations.media.Content(
        schema = @io.swagger.v3.oas.annotations.media.Schema(implementation = com.cs5500.NEUEat.dto.request.FinishOrderRequest.class)
      )
    )
