...
public class OrderController {
  ...
  @io.swagger.v3.oas.annotations.parameters.RequestBody(
      ...
      content = @io.swagger.v3.oas.annotations.media.Content(
          schema = @io.swagger.v3.oas.annotations.media.Schema(implementation = com.cs5500.NEUEat.dto.request.OrderCreateRequest.class)
      )
  )
  ...
  @PostMapping(path = "/checkoutAll")
    @io.swagger.v3.oas.annotations.parameters.RequestBody(
      description = "Checkout multiple orders request",
      required = true,
      content = @io.swagger.v3.oas.annotations.media.Content(
        schema = @io.swagger.v3.oas.annotations.media.Schema(implementation = com.cs5500.NEUEat.dto.request.OrderCreateRequest.class)
      )
  ...
  @PostMapping(path = "/addComment")
    @io.swagger.v3.oas.annotations.parameters.RequestBody(
      ...
      required = true,
      content = @io.swagger.v3.oas.annotations.media.Content(
        schema = @io.swagger.v3.oas.annotations.media.Schema(implementation = com.cs5500.NEUEat.dto.request.AddCommentRequest.class)
      )
    )
